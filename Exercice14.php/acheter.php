...
<body>
    ...
    <section class="content">
        <h2>Bienvenue dans notre section Achat</h2>
        <p>Découvrez les propriétés disponibles à l'achat :</p>

        <!-- Liste des propriétés à acheter -->
        <div class="property">
            <img src="xxx.jpg" alt="Propriété 3">
            <h3>Nom de la propriété 3</h3>
            <p>Description de la propriété 3. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <p>Prix: $600,000</p>
            <input type="submit" class="buton" name="action" value="Acheter">
        </div>

        <div class="property">
            <img src="yyy.jpg" alt="Propriété 4">
        ...
        <div class="property">
            <img src="www.jpg" alt="Propriété 4">
            <h3>Nom de la propriété 4</h3>
            <p>Description de la propriété 4. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <p>Prix: $700,000</p>
            <input type="submit" class="buton" name="action" value="Acheter">
        ...
        <div class="property">
            <img src="zzz.jpg" alt="Propriété 4">
            <h3>Nom de la propriété 4</h3>
            <p>Description de la propriété 4. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <p>Prix: $900,000</p>
            <input type="submit" class="buton" name="action" value="Acheter">
    ...
    <div class="container">
        <h1>Contenu de la page Acheter</h1>
    </div>
</body>
</html>
<style>
